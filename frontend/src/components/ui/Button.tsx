...
const variantDesign: variantStyles = {
    "primary": "bg-prple-50 text-btn_txt1-100 hover:bg-prple-100 active:bg-prple-200",
    "secondary": "bg-prple-500 text-btn_txt2-100 hover:bg-prple-600 active:bg-prple-700",
}
...
export const Button = (props: ButtonProps) => {
    ...
    return (
       <>
        <button className={style}> {props.startIcon}  {props.text} {props.endIcon}
        </button>
       </>
    )
}